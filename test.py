...
parser.add_argument('--data_path', type=str, default='/home3/shpb49/Data/UIR/Dataset/testset_paired/test-EUVP/valid/input')
parser.add_argument('--target_path', type=str, default='/home3/shpb49/Data/UIR/Dataset/testset_paired/test-EUVP/valid/target')
...
parser.add_argument('--weights', type=str, default='/home3/shpb49/Postdoc/IJCNN_UIE_SNN/base3_multispike/checkpoints/EUVP_final/models/DID-Data_new/model_best.pth')
    ...
    with torch.no_grad():
        for input_, target_, file_ in tqdm(eval_loader, unit='img'):
            ...
            for i, data in enumerate(split_data):
                ...
                # Some checkpoints/models return multi-scale outputs: (level3, level2, final)
                if isinstance(out, (tuple, list)):
                    out = out[-1]
                split_data[i] = out.detach().cpu()
